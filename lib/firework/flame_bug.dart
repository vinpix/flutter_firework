...
class FireworkParticleComponent extends PositionComponent {
  final PerlinNoise perlinNoise = PerlinNoise(frequency: 0.01);
...
class PerlinNoiseParticle extends AcceleratedParticle {
  ...
  final double noiseScale = 4; // Increased scale for more noticeable effect
  final double noiseStrength = 200; // Increased strength for more impact
